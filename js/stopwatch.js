class State {
  ...
  class Stopwatch {
    constructor(state) {
      ...
      document.querySelector(".start-stopwatch").addEventListener("click", this.handleClickStart);
      this.handleClickStop = this.handleClickStop.bind(this);
      document.querySelector(".stop-stopwatch").addEventListener("click", this.handleClickStop);
      this.handleClickReset = this.handleClickReset.bind(this);
      document.querySelector(".reset-stopwatch").addEventListener("click", this.handleClickReset);
    ...
    render() {
      ...
      document.querySelector(".hundredths").textContent = hundredths;
    }
  }
